...
class DnsPodRecordSyncTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->syncAllRecordService        = new SyncAllRecordService(
        ...
        $this->controller = new DnsPodRecordSyncController($this->mockDnsPodRecordSyncService, $this->syncAllRecordService);
